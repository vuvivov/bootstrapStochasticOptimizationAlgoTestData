function dataGen(nv,x00,bound,seedStart,seedEnd)
%nv=5
nf=5;
nSeed=seedEnd-seedStart+1;
...
for j=seedStart:seedEnd
    ...
    if mod(j,99)==0
        save(['data' num2str(nv) 'from' num2str(seedStart) 'to' num2str(seedEnd)],'data');
    end
end
% 
% temp=1:nSeed;
